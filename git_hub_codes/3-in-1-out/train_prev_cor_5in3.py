...
import cv2
import tqdm
from network_5in3 import Network
import load
import logging
...
dir1='/home/avisek/vineel/glcic-master/3_in_1_video/output_5in3_prevcor/'
dir2='/home/avisek/vineel/glcic-master/3_in_1_video/original_5in3_prevcor/'
dir3='/home/avisek/vineel/glcic-master/3_in_1_video/perturbed_5in3_prevcor/'
    ...
    while sess.run(epoch) < Tot_EPOCH:
        ...
        #=======================================    Discrimitation network - phase 2 ========================================================
		    ...
		    for k in range(3):
	                    ...
	                    local_x_batch.append(x_batch[j][1+k][int(y1):int(y2)+1, int(x1):int(x2)+1, :])
