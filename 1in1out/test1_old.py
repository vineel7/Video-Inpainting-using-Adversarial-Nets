...
out_loc4='/home/avisek/vineel/glcic-master/baseline_codes/test_output/generated/'
out_loc5='/home/avisek/vineel/glcic-master/baseline_codes/test_output/masked/'
out_loc='/home/avisek/vineel/glcic-master/baseline_codes/test_output/blend/'
...
def test():
    ...
    x_test = np.load('/home/avisek/vineel/glcic-master/baseline_codes/npy_test/x_test.npy')
    #points_batch =  np.load('/home/avisek/vineel/glcic-master/3_in_1_video_seperable/npy_test/x_points.npy')
    mask1_batch = np.load('/home/avisek/vineel/glcic-master/baseline_codes/npy_test/x_mask.npy')
    ...
    print(x_gen.shape)
    np.save('/home/avisek/vineel/glcic-master/baseline_codes/npy_pos/x_raw.npy',x_raw)
    np.save('/home/avisek/vineel/glcic-master/baseline_codes/npy_pos/x_mask.npy',x_mask)
    np.save('/home/avisek/vineel/glcic-master/baseline_codes/npy_pos/x_inpaint.npy',x_inpaint)
    #np.save('/home/avisek/vineel/glcic-master/baseline_codes/npy_pos/x_points.npy',x_points)
    np.save('/home/avisek/vineel/glcic-master/baseline_codes/npy_pos/x_gen.npy',x_gen)
