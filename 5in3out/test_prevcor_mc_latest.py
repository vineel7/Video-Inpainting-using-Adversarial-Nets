...
def test():
    ...
    sess.run(init_op)
    if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/5_in_3_video/backup_5_in_3_mc'):
        saver = tf.train.Saver()
        saver.restore(sess, '/home/avisek/vineel/glcic-master/5_in_3_video/backup_5_in_3_mc/latest')
    for c in range(8):
        ...
        for i in tqdm.tqdm(range(step_num-2)):
            ...
            for i in range(BATCH_SIZE):
                ...
                cv2.imwrite(str(out_loc2)+'inpainted__%05d.jpg' % (cnt+1), (completed1))
                cv2.imwrite(str(out_loc2)+'inpainted__%05d.jpg' % (cnt+2), (completed2))
