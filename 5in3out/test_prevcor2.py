...
def test():
    ...
    #if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/5_in_3_video/5_in_3_old/backup'):
    #    saver = tf.train.Saver()
    #    saver.restore(sess, '/home/avisek/vineel/glcic-master/5_in_3_video/backup/5_in_3_old/60')
