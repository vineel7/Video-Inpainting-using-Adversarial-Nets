...
logging.basicConfig(level=logging.DEBUG, filename='/home/avisek/vineel/glcic-master/5_in_3_video/lossvalues_prevcor_v1.log',filemode='a+',format='%(asctime)s %(message)s')
...
def train():
    ...
    """ if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/5_in_3_video/backup_5in3_celebA'):
        saver = tf.train.Saver()
        saver.restore(sess, '/home/avisek/vineel/glcic-master/5_in_3_video/backup_5in3_celebA/20') """
