...
def test():
    ...
    if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/5_in_3_video/backup/backup_5in3_old'):
        saver = tf.train.Saver()
        saver.restore(sess, '/home/avisek/vineel/glcic-master/5_in_3_video/backup/backup_5in3_old/60')
