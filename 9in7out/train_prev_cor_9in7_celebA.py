#   9in7out model trained on celebA
import numpy as np
...
logging.basicConfig(level=logging.DEBUG, filename='/home/avisek/vineel/glcic-master/9_in_7_video/lossvalues_prevcor_celebA.log',filemode='a+',format='%(asctime)s %(message)s')

dir1='/home/avisek/vineel/glcic-master/9_in_7_video/output_prevcor_celebA/'
dir2='/home/avisek/vineel/glcic-master/9_in_7_video/original_prevcor_celebA/'
dir3='/home/avisek/vineel/glcic-master/9_in_7_video/perturbed_prevcor_celebA/'
...
def train():
    ...
    data_path = '/home/avisek/vineel/glcic-master/9_in_7_video/npy_celebA/'
...
def save_samples(dir,cnt,loss,x_batch):
        ...
        for i in range(BATCH_SIZE):
                for j in range(frames_no):
                        ...
                        cv2.imwrite(str(dir)+'inpainted_epoch_'+str(cnt)+'frame_%02d.jpg' % (frames_no*i+j) ,(frame))
