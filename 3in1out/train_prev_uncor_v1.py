...
logging.basicConfig(level=logging.DEBUG, filename='/home/avisek/vineel/glcic-master/3_in_1_video/lossvalues.log',filemode='a+',format='%(asctime)s %(message)s')

dir1='/home/avisek/vineel/glcic-master/3_in_1_video/output/'
dir2='/home/avisek/vineel/glcic-master/3_in_1_video/original/'
dir3='/home/avisek/vineel/glcic-master/3_in_1_video/perturbed/'
...
def train():
    ...
    model = Network(x, mask, points, local_x, is_training, batch_size=BATCH_SIZE,local_size=LOCAL_SIZE)
    sess = tf.Session()
    ...
    variable_to_restore = [var for var in variables_r if 'new' not in var.name]
    checkpoint_path = './restore_prevcur_128/latest'
    saver_pre = tf.train.Saver(variable_to_restore)
    saver_pre.restore(sess, checkpoint_path)
