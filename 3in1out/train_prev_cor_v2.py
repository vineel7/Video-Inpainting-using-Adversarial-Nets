#      script for training 3in1 using vidtimit dataset on pretrained model (on celebA dataset)
import numpy as np
...
logging.basicConfig(level=logging.DEBUG, filename='/home/avisek/vineel/glcic-master/3_in_1_video/lossvalues_prevcor_vid1.log',filemode='a+',format='%(asctime)s %(message)s')

dir1='/home/avisek/vineel/glcic-master/3_in_1_video/output_prevcor_vid1/'
dir2='/home/avisek/vineel/glcic-master/3_in_1_video/original_prevcor_vid1/'
dir3='/home/avisek/vineel/glcic-master/3_in_1_video/perturbed_prevcor_vid1/'
...
def get_points2(x_batch):
    ...
    mask = []
    global x,y,w,h
    x,y,w,h=np.array([0,0,IMAGE_SIZE,IMAGE_SIZE])
    for i in range(BATCH_FRAME_SIZE):
