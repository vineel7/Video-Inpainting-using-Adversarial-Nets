...
def test():
    ...
    #sess.run(init_op)
    if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/3_in_1_video/backup_celebA/'):
        saver = tf.train.Saver()
        saver.restore(sess, '/home/avisek/vineel/glcic-master/3_in_1_video/backup_celebA/latest')
    for c in range(8):
        ...
        out_loc1='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/original/'
        out_loc2='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/inpainted/'
        out_loc3='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/perturbed/'
        out_loc4='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/generated/'
        out_loc5='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/masked/'
        out_loc='/home/avisek/vineel/glcic-master/3_in_1_video/test_output/p'+str(c+1)+'/blend/'
        ...
        #print(x_gen.shape)
        #np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_crop_pos/x_raw'+str(c+1)+'.npy',x_raw)
        #np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_crop_pos/x_mask'+str(c+1)+'.npy',x_mask)
        #np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_crop_pos/x_inpaint'+str(c+1)+'.npy',x_inpaint)
        #np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_crop_pos/x_gen'+str(c+1)+'.npy',x_gen)
