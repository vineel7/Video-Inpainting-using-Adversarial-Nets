...
def test():
    ...
    if tf.train.get_checkpoint_state('/home/avisek/vineel/glcic-master/3_in_1_video/backup_crop_vid_celebA/'):
        saver = tf.train.Saver()
        saver.restore(sess, '/home/avisek/vineel/glcic-master/3_in_1_video/backup_crop_vid_celebA/latest')
    for c in range(8):
        ...
        #print(x_gen.shape)
        np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_pos/x_raw'+str(c+1)+'.npy',x_raw)
        np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_pos/x_mask'+str(c+1)+'.npy',x_mask)
        np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_pos/x_inpaint'+str(c+1)+'.npy',x_inpaint)
        np.save('/home/avisek/vineel/glcic-master/3_in_1_video/npy_pos/x_gen'+str(c+1)+'.npy',x_gen)
